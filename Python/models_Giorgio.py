...
from keras.layers import BatchNormalization, Activation, GlobalAveragePooling2D, LeakyReLU
from keras.layers.convolutional import UpSampling2D, Conv2D, DepthwiseConv2D, SeparableConv2D, MaxPooling2D, Conv2DTranspose
